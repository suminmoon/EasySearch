...
def result(request, serial_no):
    ...
    try:
        ...
        print(context_enuri)
        # return render(requevvvvvvvvvvst, 'pages/result.html', context)

    except Exception:
        context_enuri={'error': '에누리 에러'}
        # return render(request, 'pages/result.html', context)
        ############################################################################################
    ...
    try:
        ...
        # context = {'naver_total_mall': naver_total_mall, 'naver_total_image': naver_total_image,
        #            'naver_total_price': naver_total_price, 'naver_total_url': naver_total_url,
        #            'enuri_total_image': enuri_total_image, 'enuri_total_mall': enuri_total_mall,
        #            'enuri_total_price': enuri_total_price, 'enuri_total_url': enuri_total_url,
        #            'danawa_total_image': danawa_total_image, 'danawa_total_mall': danawa_total_mall,
        #            'danawa_total_price': danawa_total_price, 'danawa_total_url': danawa_total_url, }
        print(context_danawa)
        # return render(request, 'pages/result.html', context)

    except Exception:
        context_danawa = {'error': '다나와 에러발생'}

    context_naver.update(context_enuri)
    # print(context_naver, type(context_naver))
