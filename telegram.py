...
def telegram_crontab():
    ...
    '''
                            ...
                            # requests.get(f'{api_url}/sendMessage?chat_id={chat_id}&parse_mode=HTML&text={t_price}')
                            requests.get(f'{api_url}/sendMessage', params=params)
                            telegramobj.delete()
